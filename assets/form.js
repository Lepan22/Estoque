...
<body>
  <div class="container mt-4">
    <h1 id="eventoTitulo">Evento</h1>
    <table class="table" id="itens-tabela">
      <thead>
        <tr>
          <th>Produto</th>
          <th>Assado</th>
    ...
    <div class="mb-3">
      <button class="btn btn-primary" id="salvarAlteracoesBtn">Salvar Alterações</button>
      <button class="btn btn-danger" id="finalizarEventoBtn">Finalizar Evento e Salvar Alterações</button>
    </div>
  </div>
  ...
  <script>
    ...
    // Botão salvar alterações - NOVA VERSÃO
